					...
					<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
						...
						<div class="row placeholders">
							...
							<div id="runbtn"class="col-xs-6 col-sm-3 placeholder">
								<a href="html/run.jsp"><img alt="200x200" class="img-responsive" src="svg/run.svg" /></a>
								<h4>
									执行测试
								</h4> <span class="text-muted">执行已有测试计划</span>
							</div>
							<div id="reportbtn"class="col-xs-6 col-sm-3 placeholder">
								<a href="html/report.jsp"><img alt="200x200" class="img-responsive" src="svg/report.svg" /></a>
								<h4>
									查看测试结果
